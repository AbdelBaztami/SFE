...
<br>
<h1 class="stock">Modifier le stock</h1>
<br>

<form method="POST" name="leForm" action="editerStock_trt.php">
<table class="tableCommune">
<tr><th>Nom</th><th>TVA</th><th>Prix unit.<br>HT</th><th>Quantite<br>réelle</th><th>Supprimer</th></tr>
<?php
	...
	for ($i=0;$i<=5;$i++) {
		echo "<tr><td><input size=\"40\" maxlength=\"255\" type='text' name='INSERT_NOM_$i' value=''></td><td><input type='text' size='4' name='INSERT_TVA_$i' value=''></td><td><input type='text' size='7' name='INSERT_PRIX_$i' value=''></td><td><input type='text' size='5' name='INSERT_QUANTITEREELLE_$i' value=''></td></tr>";
	}
?>
</table>
