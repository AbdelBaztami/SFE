<?php
	...
	foreach ($sorties as $sortie) {
		...
		$tableStatCoutMois[$mois]+=($sortie->coutTTCTotal-$charge);
	}
...
<CENTER>
<br>
<h1 class="stock">Coût des sorties réelles, par mois</h1>
<form action="statCoutParMois.php" method="post">
	<input type="text" name="txtcharge" placeholder="charge de mois">
...
<br>
<h2 style="font-size:18px">Total par mois</h2>
<br>
...
<br><br>
<h2 style="font-size:18px">Total par sorties groupées (nombre / coût EUR TTC)</h2>
<br>
<table class="tableCommune">
<?php
	echo "<tr>";
