...
<br>
<h1 class="stock">Sortie : <?php echo $sortie->nom;?></h1>
...
<tr><th>Nom<br></th><?php if ($bUtiliseBeneficiaire) echo "<th>Bénéficiaire</th>";?><th>Prix unit.<br>(TTC)</th><th>Avance</th><th>Reste</th><th>Quantité</th><th>Prix total<br>(TTC)</th></tr>
<?php
	foreach ($sortie->tLigneSortie as $ligneSortie) {
		$nom=$ligneSortie->article->nom;
		$prixTTCSortie=$ligneSortie->prixTTCSortie;
		$Avance=$ligneSortie->Avance;
		$Reste=$prixTTCSortie-$Avance;
		...
		echo "<td class=\"tdPrix\">$prixTTCSortie</td><td class=\"tdPrix\">$Avance</td><td class=\"tdPrix\">$Reste</td><td class=\"tdQuantite\">$quantite</td><td class=\"tdPrix\">$prixTotal</td></tr>";
	}
	
	$colSpan=($bUtiliseBeneficiaire?5:4);
