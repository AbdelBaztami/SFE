...
<br>
<h1 class="stock">Liste des sorties</h1>
<br>
<h2>Filtre :&nbsp;&nbsp;
...
<option <?php echo ($periodeFiltre=="N30"   ?" selected":""); ?> value="N30">Les 30 dernières</option></h2>
	<?php
...
<tr><th width="20%">Nom<br><span style="font-weight:normal;font-size:10px;font-style:italic;">Cliquer pour afficher</span><br></th><th width="25%">Commentaire</th><th width="1%">Date</th><th width="1%">Etat</th><th width="1%">Coût total<br>(TTC)</th><th width="1%">Nbre<br>articles</th><th width="1%">Modif.</th><th width="1%">Sup.</th><th nowrap width="1%">Changer état</th></tr>
<?php
